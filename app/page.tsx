...
export default function DashboardPage() {
  return (
    <div className="min-h-screen bg-slate-200/70 flex items-center justify-center p-8">
      <div className="w-full max-w-315 rounded-[26px] bg-white shadow-[0_30px_80px_rgba(15,23,42,0.12)] overflow-hidden">
        <div className="grid grid-cols-[248px_1fr] min-h-190">
          ...
          <main className="bg-slate-100 px-8 py-7">
